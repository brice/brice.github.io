...
> Une liste de ressources d'apprentissage du Japonais.

(Traduit et librement inspiré du projet [Awesome Japanese](https://github.com/yudataguy/Awesome-Japanese))

## Table des matières

- [Présentation](#ressources-dapprentissage)
  - [Table des matières](#table-des-matières)
  - [Légende et pictogrammes](#légende-et-pictogrammes)
  - [Guide du débutant](#guide-du-débutant)
  - [Textbook](#manuels)
    - [Genki 👶](#genki-baby)
    - [Tobira 👴](#tobira-older_man)
    - [Minna no Nihongo 👨](#minna-no-nihongo-man)
...
1. A summary of the guides is basically this: first, learn hiragana and katakana using the links in [Hiragana/Katakana](#hiragana-and-katakana) section further down this page. The Tofugu links are a good starting place.
...
*Les manuels vous fournissent une structure d'apprentissage*
...
- [Site officiel](https://genki3.japantimes.co.jp/fr/intro/) 🇫🇷
...
<!-- - Amazon💰:
  ...
  - [Genki Answer Key](http://amzn.to/2sX4ZF8)
   -->
- Anki Deck📇:
  - [Genki 1 & 2](https://ankiweb.net/shared/info/1132238466) - All the vocab from Genki 1 & 2 and more. ⚠️ Still updating.
...
- [LingoDeer](https://www.lingodeer.com/) - Japanese course on a new learning app similar to Duolingo, but made with a focus on East Asian languages. 📱
- [NativShark](https://nativshark.com/) - All in one Japanese learning platform, combining vocab, grammar, kanji and speaking practice. 💰
- [NHK 高校講座 / NHK High School Course](https://www.nhk.or.jp/kokokoza/) - Video or audio of high school course made by NHK. Easy to study the basic glossaries of different fields. 👨
- [Drops: Language learning app](https://languagedrops.com/) - Duolingo-like app which offers 5 minutes/day free flashcards-based app separated by categories. 📱
...
- App
  - [Hiragana and Katakana](https://itunes.apple.com/us/app/hiragana-and-katakana-complete-basics-of-japanese/id385817288?mt=8) - iOS Hiragana and Katakana learning app 📱
  - [Kakugo](https://play.google.com/store/apps/details?id=org.kaqui) - Android hiragana, katakana and kanji learning app 🤖
  - [Kanji Dojo](https://play.google.com/store/apps/details?id=ua.syt0r.kanji) - Android application for practicing writing Japanese characters 🤖
- Anki Deck
  - [Hiragana + Katakana w/ Audio & Stroke Order](https://ankiweb.net/shared/info/1632090287) - 📇
...
- [Wanikani](https://www.wanikani.com/) - Kanji learning platform. 💰
- Anki Deck
  ...
  - [Kodansha kanji learner's course with vocabulary](https://ankiweb.net/shared/info/779483253) - 📇 This deck is meant to be used together with the Kodansha Kanji Learner's Course book (KLC).
  - [Official KanjiDamage deck](https://ankiweb.net/shared/info/748570187) - 📇 This is the ultimate deck to learn Kanji with the KanjiDamage method.
  - [All in One Kanji Deck (Heisig's RTK Order, 6th ed.)](https://ankiweb.net/shared/info/1862058740) - 📇 Based on Heisig's Remember the Kanji 6th ed. book.
...
- [Anki](https://apps.ankiweb.net/) - Logiciel populaire de flashcard. 📱 💻 🇫🇷
  - [Manuel utilisateur](https://apps.ankiweb.net/docs/manual.html)
  ...
  - [Japanese Core 2000/6000 A](https://docs.google.com/document/d/1zyyuiWkiz2IF2CCROeJebl8mgRdHBqNfS5D7MFjDTzE/edit) - [B](https://djtguide.neocities.org/anki.html) - 📇 Popular Anki Japanese Deck Core 2k/6k
  - [Japanese 10K WK Breakdown](https://mega.nz/#!AdRjlZoL!FZoz3f3jq4oFUvwa59-AN3yKuQn-mFuIgNDftHtJ8n0) - 📇 Core 10K vocabulary, broken down by WaniKani kanji.
  - [Kaishi 1.5K 🇫🇷](https://ankiweb.net/shared/info/1667806715) - Une alternative au Core 2k, avec image, audio et en français
  - [Qu'est ce que Anki ?](https://brice.github.io/articles/Anki-Deck/) - 🇫🇷 Un article sur mon usage personnel de Anki
...
- [SakeSaySo](https://sakesayso.com/) - A Japanese-English dictionary app featuring SRS flashcards, daily news translations for sentence-based learning, vocabulary inspection, and example sentences. Supports offline use. 📱
...
- 📚Amazon💰:
  - [A Dictionary of Basic Japanese Grammar](http://a.co/fMGHlG2) - Popular Japanese grammar dictionary series. 👶
  - [A Dictionary of Intermediate Japanese Grammar](http://amzn.to/2txGg9H) - 👨
  - [A Dictionary of Advanced Japanese Grammar](http://amzn.to/2u1pLVg) - 👴
- [Dictionary of Japanese Grammar](https://dojgdeck.neocities.org/) - 📇 The DoJG deck allows you to review the contents of the Dictionary of Japanese Grammar through Anki.
- [Bunpro](https://bunpro.jp/) - Grammar learning web app using SRS. 💰
- [Sakubi](https://sakubi.neocities.org/) - Basic grammar primer that doesn't try to drill you 👶

## Reading

- [NHK Easy News](https://www3.nhk.or.jp/news/easy/) - News for elementary, middle school, and foreigners with audio and video. 👶
...
- [Tadoku](https://tadoku.org/japanese/en/free-books-en/) - Illustrated books for elementary learners. Some books require purchase. 👶 💰
...
- [Hukumusume Fairy Tale Collection](https://hukumusume.com/douwa/) - A website where you can read and hear traditional folk tales, legends and fairy tales - from Japan and all around the world - read aloud for you in Japanese. 🇯🇵
- [Kyoko Shinbun](https://kyoko-np.net/index.html) - Fake Japanese News (similar to The Onion), podcast available. 📱 🇯🇵 👴
...
- [Manabi Reader](https://reader.manabi.io) - Web, RSS, and EPUB ebook reader for looking up words, tracking vocabulary and kanji learning progress, and adding flashcards into Anki or Manabi Flashcards. Includes free library of curated native reading material. 📱 💻

## Listening

- [SuperNative](https://supernative.tv/) - Trains you to hear, read, and speak Japanese using over 10,000 bite-sized clips from TV and movies. ⚠️ Only Chrome browser supports voice recognition practice.
...
- Podcast
  ...
  - [News in Slow Japanese](http://newsinslowjapanese.com/) - Listen to Japanese News in slow speed. 💰
  - [NHK News Podcast](https://www.nhk.or.jp/podcasts/) - Three podcasts available: Japanese news 👴, English news, and Easy Japanese.
...
- [Discord](https://discord.com/) - Popular chatroom platform. 📱 💻
...
- News
  ...
  - [Fuji News Network](https://fnn-news.com/) - FNN live and VOD.
...
- Stream
  ...
  - [Abema TV](https://abema.tv/) - Live Japanese TV stream. 📱 🇯🇵
  - [GYAO!](https://gyao.yahoo.co.jp/) - Japanese TV programs on demand. 📱 🇯🇵
  - [FRESH!](https://freshlive.tv/) - Japanese streamer platform. 📱
  - [NicoNico](https://www.nicovideo.jp/) - Japanese streamer platform. 📱
...
- Web
  ...
  - [Weblio](https://www.weblio.jp/) - Comprehensive Japanese dictionary portal. 🇯🇵
  - [Google Translate](https://translate.google.com/) - Supports voice and image translation, mobile app supports offline translation. 📱
  - [語源由来辞典 / Gogen Yurai jiten](https://gogen-yurai.jp/) - Etymology of Japanese. 👨
  - [Goo 辞書 / Goo Dictionary](https://dictionary.goo.ne.jp/) - Online Japanese dictionary. 🇯🇵

- Software
  - [Houhou](http://houhou-srs.com/) - The dictionary doubles as a learning tool. 💻
  - [Takoboto](https://play.google.com/store/apps/details?id=jp.takoboto) - Android Japanese dictionary app, also has web and computer based version. 🤖 💻
  - [imiwa?](https://www.imiwaapp.com/) - iOS Japanese dictionary app. 📱
  - [Tagaini Jisho](https://www.tagaini.net/) - Open-source Japanese dictionary and kanji lookup tool for Windows, MacOS X and Linux.
  - [Jiten](https://play.google.com/store/apps/details?id=dev.obfusk.jiten) - Android Japanese dictionary and kanji lookup app, also has web version. 🤖
  - [Japanese](https://www.japaneseapp.com/) - Dictionary, stroke order and flashcards for iOS 📱
...
- Computer
  - [Human Japanese](https://www.humanjapanese.com) - Popular Japanese learning program. 📱 💻 💰
  - [Google Japanese Input](https://www.google.co.jp/ime/) - Google Japanese Input, available on Windows, Mac, and Android. 💻
...
- Browser Extension🛰️:
  ...
  - Safari
    ...
    - [Toucan - Language Learning](https://jointoucan.com/) - When you visit a website, Toucan automatically translates certain words and phrases on the page into the language you're trying to learn. 📱
